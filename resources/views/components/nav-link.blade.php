...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-sky-500 text-sm font-semibold leading-5 text-sky-700 focus:outline-none focus:border-sky-700 transition duration-150 ease-in-out'
